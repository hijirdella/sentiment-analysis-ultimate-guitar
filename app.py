...
model = joblib.load('LogisticRegression - Ultimate Guitar.pkl')
vectorizer = joblib.load('tfidf_vectorizer_Ultimate Guitar.pkl')
label_encoder = joblib.load('label_encoder_Ultimate Guitar.pkl')

# --- Judul App ---
st.title("🎸 Sentiment Analysis - Ultimate Guitar App")
    ...
    if st.button("Prediksi Sentimen"):
        if user_review.strip() == "":
            ...
            st.download_button(
                ...
                data=csv_manual,
                file_name="manual_review_prediction_ultimate_guitar.csv",
                mime="text/csv"
            )
        ...
        try:
            ...
            if 'review' not in df.columns:
                ...
                st.download_button(
                    ...
                    data=csv_result,
                    file_name="predicted_reviews_ultimate_guitar.csv",
                    mime="text/csv"
                )
